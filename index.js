...
<ul>
  <li>[브랜드] 제품명 – 어떤 성분이 포함되어 있으며, 그 성분이 어떤 피부 문제에 효과적인지, 사용 시점(예: 아침/저녁/주 2회 등)과 사용 방법까지 함께 설명해주세요.</li>
  <li>[브랜드] 제품명 – 위와 동일한 방식으로, 감성적이고 따뜻한 말투로 서술하세요. 사용자가 왜 이 제품을 선택해야 하는지 설득력 있게 설명해주세요.</li>
  <li>[브랜드] 제품명 – 전문가가 추천하는 느낌으로, 구체적인 사용 상황(예: 피부 진정이 필요할 때, 탄력이 부족할 때 등)도 함께 담아주세요.</li>
</ul>
